    ...
    def _batch_messages(
        ...
        *,
                ...
                "predictive_hypothesis_updates": [
                    {
                        ...
                        "action": "CREATE_TRADING_CANDIDATE_V2 for new candidates; legacy validation actions apply only to legacy records",
                        "hypothesis_id": "stable string",
                        "statement": "CREATE_TRADING_CANDIDATE_V2 only: frozen predictive proposition",
                        "success_definition": "CREATE_TRADING_CANDIDATE_V2 only: predeclared objective success condition",
                        "minimum_required_trials": "CREATE_TRADING_CANDIDATE_V2 only: positive integer selected before blind testing",
                        "source_result_ids": "CREATE_TRADING_CANDIDATE_V2 only: supporting result IDs already completed in that RP",
                        "executable_policy": {
                            "entry": "observable entry rule", "direction": "long or short",
                            "instrument": "traded instrument", "prediction_point": "information boundary T",
                            "favorable_exit": "realizable favorable exit", "adverse_risk_unit": "frozen R definition",
                            "stop_or_invalidation": "realizable adverse exit", "maximum_horizon": "time exit",
                            "gap_fill_treatment": "gap and fill mechanics", "position_management": "permitted management",
                            "all_in_cost_assumption": "commissions spread slippage impact",
                            "applicable_population_or_regime": "frozen applicability",
                        },
                        "exploratory_candidacy_assessment": {
                            "mean_realized_gross_expectancy": "numeric under chronological policy",
                            "mean_estimated_all_in_cost": "numeric in same units",
                            "mean_realized_net_expectancy": "numeric gross minus costs and strictly positive",
                            "expectancy_units": "nonblank common units, preferably frozen R units",
        ...
        instructions = [
            ...
            "For new trading-hypothesis candidacy use only action=CREATE_TRADING_CANDIDATE_V2. Do not use the legacy CREATE_TENTATIVE action, which remains readable solely for historical records created under superseded governance.",
            "A relationship may remain a scientific observation or finding without becoming a trading-hypothesis candidate. Create a V2 candidate only when completed exploratory Analysis supports a specific falsifiable T-to-future relationship and a human-executable chronological policy with positive estimated net expectancy after costs.",
            "There is no universal candidacy success-rate, ATR-movement, or payoff threshold. Do not use the former greater-than-60-percent/1.5-ATR reference as the candidate definition. Do not apply the later 0.15R and 2C trading-promotion floors as research targets or candidacy requirements.",
            ...
            "LOCK_VALIDATION_TRIAL and RECORD_VALIDATION_OUTCOME are legacy binary-ledger actions and may not be used to claim validation of a V2 trading candidate. A V2 validation path must preserve the separate uncertainty-adjusted expectancy assessment required by the amended lifecycle.",
            "Trading promotion is separate: prospective-paper eligibility requires conservative path-executable net expectancy > 0, point-estimate net expectancy >= 0.15R, and point-estimate gross expectancy >= 2C, with R the frozen adverse-risk unit and C upper-bound all-in cost. This is a rejection floor, not a research target or live authority. The present binary trial ledger does not yet represent that complete assessment; do not claim its status alone satisfies the amended gate.",
            "For future screening, distinguish eligibility from ranking and capital selection. Preserve every eligible candidate, including candidates not selected for capital, so portfolio constraints do not bias prospective hypothesis evidence. Ranking may compare conservative expectancy, capital efficiency, holding time, adverse path, uncertainty, liquidity, regime, cost sensitivity, capacity, and correlation, but may not alter the frozen hypothesis.",
        ]
        user = {
            "operation": operation,
            "mission": mission,
