        ...
        *,
        ...
        payload = {
            ...
            "instructions": [
                ...
                "The Research Frontier is advisory scientific working memory, not a queue, mandate, or parameter contract for later EXPLORATION.",
                "Do not let one active or successful research line become the default discovery space. Preserve the possibility that later subjects are best studied with different lookbacks, forward horizons, thresholds or normalization, targets, evidence streams, interactions, regimes, methods, or entirely different propositions.",
                "Do not present a prior numeric threshold, lookback, forward horizon, method, or target as a universal default unless the accumulated evidence specifically supports that generalization. A negative result for one formulation does not establish absence of predictive structure under other scientifically justified formulations.",
                "When useful, record alternative parameterizations or materially different unanswered directions alongside continuation/generalization questions so later Research Directors can choose among them scientifically.",
