...
The human has determined that authoritative historical point-in-time index membership is not a prerequisite for the present-day market-understanding and predictive-discovery program. The frozen current-member calibration universe may support calibration and discovery when survivorship and former-member omissions remain explicit. Those results may describe relationships within the observed current-member population, but may not be represented as an authoritative historical S&P 500 reconstruction. This decision removes historical membership acquisition as a readiness gate; it does not relax prediction-time integrity for predictors, outcomes, earnings, shares, timestamps, or blind validation.
